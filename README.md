...
- **Modo oscuro/claro** — toggle con JavaScript que persiste en la sesión.
...
- **FAQ interactivo** — usando `<details>` y `<summary>` nativos de HTML.
- **Formulario de contacto** — con validación visual mediante CSS.
- **Footer con enlaces legales** — Términos y Condiciones / Política de Privacidad.

## 🎨 Decisiones de diseño

- **Tipografía:** Georgia (cuerpo) + Helvetica Neue (UI y etiquetas).
- **Paleta:** tonos neutros cálidos con acento azul-grisáceo (`#5b6e8c`).
